...
class AnketaForm(forms.Form):
    ...
    job = forms.CharField(label='Ваш род занятия', min_length=2, max_length=100)
...
class BlogForm(forms.ModelForm):
    class Meta:
        ...
        labels = {'title': "Заголовок", 'description': "Краткое содержание", 'content': "Полное содержание", 'image': "Каринка"}
